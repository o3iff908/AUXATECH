                            ...
                            <div className="col-tact-stye-one col-lg-4">
                                <div className="contact-style-one-info">
                                    <ul className="contact-address">
                                        <li>
                                            <a className="phone-link" href="tel:+44 757 589 1777"><i className="fas fa-user-headset" /> +44 757 589 1777</a>
                                        </li>
                                        <li>
                                            <div className="info">
                                                <h4>Location</h4>
                                                <p>
                                                    CIS Tower, Miller St, M4 4AH <br /> Manchester, United Kingdom
                                                </p>
                                            </div>
                                        </li>
                                        <li>
